...
$("#verDatos").on("click", function () {
  ...
  usuariosAgregados.forEach((element) => {
    ...
    let html =
      `<div class="col-xs-12 col-sm-6 col-md-4"> <div class="image-flip" > <div class="mainflip flip-0"> <div class="frontside"> <div class="card ${className}"> <div class="card-body text-center"> <p><img class=" img-fluid" src="` +
